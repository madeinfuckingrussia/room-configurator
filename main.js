// elm-watch hot {"version":"1.2.6","targetName":"Raumplaner","webSocketPort":36461,"webSocketToken":"b08f3545-8129-494a-9091-d28de5566a7c"}
"use strict";
(() => {
...
// added by elm-watch
var _elmWatchTargetName = "Raumplaner";
...
var $author$project$Main$GotInspirations = function (a) {
	return {$: 'GotInspirations', a: a};
};
...
var $author$project$Main$Template = F2(
	function (name, code) {
...
var $author$project$Main$templatesDecoder = $elm$json$Json$Decode$list(
	A3(
		$elm$json$Json$Decode$map2,
		$author$project$Main$Template,
		A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'code', $elm$json$Json$Decode$string)));
var $author$project$Main$getInspirations = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GotInspirations, $author$project$Main$templatesDecoder),
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				...
				case 'FetchInspirations':
					return _Utils_Tuple2(model, $author$project$Main$getInspirations);
				case 'GotInspirations':
					if (msg.a.$ === 'Ok') {
						var templates = msg.a.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{isOpenToaster: true, toasterClass: 'is-danger', toasterMsg: 'Fehler beim Laden der Vorlagen'}),
							$elm$core$Platform$Cmd$none);
					}
				default:
					var code = msg.a;
					var oldGrid = model.canvasGrid;
					var updatedHistory = A2($elm$core$List$cons, oldGrid.items, model.history);
					var newItems = $author$project$Main$roomDecoder(code);
					var newFloor = $author$project$Main$floorDecoder(code);
					var newCanvasSize = $author$project$Main$canvasSizeDecoder(code);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$core$String$fromFloat(item.height)),
										$elm$svg$Svg$Attributes$fill('none'),
										$elm$svg$Svg$Attributes$stroke('#00a8ff'),
										$elm$svg$Svg$Attributes$strokeWidth('2'),
										$elm$svg$Svg$Attributes$strokeDasharray('4 4')
									]),
								_List_Nil)
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('button is-light m-2'),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('menu p-4 animate__animated ' + animationClass)
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$Main$FetchInspirations = {$: 'FetchInspirations'};
var $author$project$Main$LoadTemplate = function (a) {
	return {$: 'LoadTemplate', a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('mt-6 is-flex is-justify-content-center')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('button is-primary has-text-weight-bold'),
								$elm$html$Html$Events$onClick($author$project$Main$FetchInspirations)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('fa-solid fa-wand-magic-sparkles')
											]),
										_List_Nil)
									])),
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Inspirations')
									]))
							]))
					])),
				$elm$core$List$isEmpty(model.inspirations) ? $elm$html$Html$text('') : A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Events$onClick(
													$author$project$Main$LoadTemplate(template.code)),
